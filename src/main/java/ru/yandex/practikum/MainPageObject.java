...
public class MainPageObject {
    ...
    //Локатор для куки
    private final static By BUTTON_COOKIE = By.id("rcc-confirm-button");

    public void clickRentPrice() {

        driver.findElement(RENT_PRICE).click();
    }
    ...
    public void clickButtonCookie(){driver.findElement(BUTTON_COOKIE).click();}
}
